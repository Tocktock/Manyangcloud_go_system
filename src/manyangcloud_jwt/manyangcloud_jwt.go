...
func GenerateJWT(privkeyfile *rsa.PrivateKey) (string,error) {
	...
	token.Claims = jwtgo.MapClaims{
        "iss":    "manyangcloud.com",      // who creates the token and signs it
        "aud":    "manyangcloud.com",  // to whom the token is intended to be sent
...
func ValidateJWT(publickeyfile *rsa.PublicKey, jwt string) (bool,error) {
	...
	// cant use !token.Valid because token is nil on fail
